...
export default function InscriptionForm() {
  ...
  return (
    <div className="min-h-screen  flex items-center justify-center p-4">
      ...
      >
        <h2 className="text-2xl font-bold text-center text-secondary font-itim">Inscription</h2>

        {/* Nom */}
        <div>
          <label className="block text-sm text-secondary font-opensans">Nom*</label>
          <input
            type="text"
            {...register('nom')}
        ...
        {/* CIN */}
        <div>
          <label className="block text-sm text-secondary font-opensans">CIN*</label>
          <input
            type="text"
            {...register('cin')}
            className={`w-full p-2 border ${
              errors.cin ? 'border-red-500' : 'border-secondary'
            } rounded`}
        ...
        {/* Email */}
        <div>
          <label className="block text-sm text-secondary font-opensans">Email*</label>
          <input
            type="email"
            {...register('email')}
            className={`w-full p-2 border ${
        ...
        {/* Mot de passe */}
        <div>
          <label className="block text-sm text-secondary font-opensans">Mot de passe*</label>
          <input
            type="password"
            {...register('motDePasse')}
            className={`w-full p-2 border ${
        ...
        <div>
          <label className="block text-sm text-secondary font-opensans">Confirmation du mot de passe*</label>
          <input
            type="password"
        ...
        <div className="flex items-center gap-2">
          ...
          <label className="text-sm text-secondary font-opensans">
        ...
        {/* Bouton */}
       <button   type="submit" className="px-4 py-4 bg-secondary text-primary rounded hover:bg-hover-button ml-16 mr-16 font-opensans font-bold ">S'inscrire</button>
      </form>
    </div>
  );
}